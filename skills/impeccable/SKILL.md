---
name: impeccable
description: Manual-invocation skill. Load only when the user explicitly asks for the impeccable skill or references it by name. Do not auto-load for general design, redesign, or UI tasks.
version: 4.1.1
---
